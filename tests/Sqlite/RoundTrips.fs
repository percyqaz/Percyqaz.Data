...
type RoundTrips() =
    ...
    member this.RoundTripById() =
        ...
        let retrieved_user_by_id =
            db |> Users.QUERY_BY_ID.Execute user_id |> expect |> Seq.exactlyOne
    ...
    member this.RoundTripByQueryAll() =
        ...
        let retrieved_id, retrieved_user =
            db |> Users.QUERY_ALL.Execute() |> expect |> Seq.exactlyOne
    ...
    member this.RoundTripBatchInsert() =
        ...
        db
        |> Users.INSERT.Batch users
        |> expect
        |> printfn "Batch insert; %A rows modified"
    ...
    member this.RoundTripBatchInsertOnDisk() =
        ...
        |> expect
        |> printfn "Table dropped if exists; %A rows modified"
